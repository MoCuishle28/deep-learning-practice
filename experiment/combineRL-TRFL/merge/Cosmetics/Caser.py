...
def parse_args():
	parser = argparse.ArgumentParser(description="Run supervised Caser.")
	...
	parser.add_argument('--base_data_dir', nargs='?', default='../../../data/Cosmetics-Shop', help='data directory')
