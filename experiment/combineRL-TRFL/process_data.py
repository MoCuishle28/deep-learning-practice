...
# print(click_df)									# 975115 条数据
# print(click_df.groupby('user_session').size())	# 123998 个 session ?
...
print(click_df)
# sampled_session_id = np.random.choice(click_df.user_session.unique(), 12400, replace=False)
# sampled_click_df = click_df.loc[click_df.user_session.isin(sampled_session_id)].reset_index(drop=True)
# print(sampled_click_df)
