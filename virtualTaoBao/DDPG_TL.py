...
if __name__ == '__main__':
	...
	if args.train:  # train
		...
		for i in range(MAX_EPISODES):
			...
			print(
				'Episode: {}/{}  | Episode Reward: {:.2f} | CTR:{:.4f}  | Running Time: {:.4f}'.format(
					i, MAX_EPISODES, ep_reward, ep_reward / MAX_EPISODES / 10, time.time() - t1 ))

			reward_buffer.append(ep_reward / MAX_EPISODES / 10)
			ep_reward = 0
	...
	for i in range(MAX_EP_STEPS):
		s, r, done, info = env.step(ddpg.choose_action(s).numpy())
		print('reward:', r)
		if done:
			break